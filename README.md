...
Поэтому необходимо написать скрипт. Для этого разберем основные этапы. Наиболее быстрый и простой способ использовать bash sh. Рассмотрим основы работы в CrossMap [3]. Типичная команда имеет такой вид: 
